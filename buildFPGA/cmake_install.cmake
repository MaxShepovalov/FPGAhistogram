# Install script for directory: /home/centos/gbm/LightGBM
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/centos/gbm/LightGBM/lightgbm")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/lightgbm" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/lightgbm")
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/home/centos/gbm/LightGBM/lib_lightgbm.so")
  if(EXISTS "$ENV{DESTDIR}/usr/local/lib/lib_lightgbm.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/lib_lightgbm.so")
    if(CMAKE_INSTALL_DO_STRIP)
...
file(INSTALL DESTINATION "/usr/local/include" TYPE DIRECTORY FILES "/home/centos/gbm/LightGBM/include/LightGBM")
endif()
...
file(WRITE "/home/centos/gbm/LightGBM/buildFPGA/${CMAKE_INSTALL_MANIFEST}"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
